...
public class TelaCurso extends javax.swing.JDialog {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        CursoDAO dao = new CursoDAO();
        List <Curso> cursos = (!tfDescricao.getText().isEmpty() ? dao.pesquisaDescricao(tfDescricao.getText())
                : dao.listar());
        
        CursoTableModel ctm = new CursoTableModel(cursos);
        
        Object o = TelaPesquisa.exibeTela(ctm, "Curso");
        
        if (o != null){
            curso = new Curso();
            curso = dao.pesquisaId(Integer.valueOf(String.valueOf(o)));
