...
public class TelaCidade extends javax.swing.JDialog {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        CidadeDAO dao = new CidadeDAO();
        List <Cidade> cidades = (!tfDescricao.getText().isEmpty() ? dao.pesquisaDescricao(tfDescricao.getText())
            : dao.listar());

        CidadeTableModel etm = new CidadeTableModel(cidades);

        Object o = TelaPesquisa.exibeTela(etm, "Cidade");
