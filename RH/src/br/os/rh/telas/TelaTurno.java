 ...
 */
public class TelaTurno extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabel5.setText("CADASTRO DE TURNO");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (Util.chkVazio(tfDescricao.getText())) {
            ...
            turno.setDescricao(tfDescricao.getText());
    ...
    private void btRemoverActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btRemoverActionPerformed
        ...
        JOptionPane.showMessageDialog(rootPane, "Turno Excluído");
    }//GEN-LAST:event_btRemoverActionPerformed

    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        TurnoDAO dao = new TurnoDAO();
        List<Turno> turnos = (!tfDescricao.getText().isEmpty() ? dao.pesquisaDescricao(tfDescricao.getText())
                : dao.listar());

        TurnoTableModel etm = new TurnoTableModel(turnos);

        Object o = TelaPesquisa.exibeTela(etm, "Turno");

        if (o != null) {
            turno = new Turno();
            turno = dao.pesquisaId(Integer.valueOf(String.valueOf(o)));

            tfDescricao.setText(turno.getDescricao());
